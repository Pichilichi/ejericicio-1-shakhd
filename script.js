...
// Después de crear el array, deberéis realizar un filtrado empleando el método del objeto "Array", "filter". NO HACE FALTA USAR FILTER. USAR CUALQUIER BUCLE
...
function filterUsers(){
  ...
  peopleFiltered = people.filter(function (e){
    return e.country == "spain" && e.money > 200;
  });
...
function onLoad(){
  createUsers() // Llamada al metodo que crea nuestros usuarios
  console.log('hi')
  console.log(people)
